...
(function () {
  ...
  function showProductSkeleton(pageData) {
    ...
    skel.innerHTML = '<div class="an-product" style="opacity:1;">' +
      ...
      (pageData.imageUrl ? '<img src="' + esc(pageData.imageUrl) + '" alt="" style="max-height:180px;opacity:0.6;">' : '<div class="an-skel-block" style="width:70%;height:160px;border-radius:8px;"></div>') +
      '</div>' +
      '</div>' +
