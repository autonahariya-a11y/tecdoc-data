...
(function () {
  ...
  /* Extract OEM/catalog code from product title */
  function extractCodeFromTitle(title) {
    if (!title) return null;
    /* Common patterns: VAG codes, dash codes, brand codes */
    var patterns = [
      /([A-Z0-9]{2,}[A-Z]\d{3,}[A-Z0-9]*)/,       /* e.g. SP1107F, 04E115561AC */
      /([A-Z]{2,}[- ]?[A-Z0-9]{2,}[- ]?[A-Z0-9]+)/, /* e.g. HU 7009 z, Hi-Q SP1376 */
      /(\d{3,}[A-Z]\d+[A-Z]*)/,                       /* e.g. 281132S000 */
      /([A-Z0-9]+-[A-Z0-9]+(-[A-Z0-9]+)*)/            /* dash-separated codes */
    ];
