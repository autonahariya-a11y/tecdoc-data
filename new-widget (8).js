...
(function () {
  ...
  var BRAND_LOGO_FILES = {
    'BREMBO':'brembo.png','BOSCH':'bosch.png','MANN-FILTER':'mann-filter.svg',
    'VALEO':'valeo.svg','TRW':'trw.svg','NGK':'ngk.svg','HELLA':'hella.svg',
    'SKF':'skf.svg','NISSENS':'nissens.png','FEBI BILSTEIN':'febi-bilstein.svg',
    'MONROE':'monroe.svg','FERODO':'ferodo.svg','LIQUI MOLY':'liqui-moly.svg',
    'MAHLE':'mahle.svg','KNECHT':'knecht.svg','SACHS':'sachs.svg',
    'CONTINENTAL':'continental.svg','HENGST FILTER':'hengst-filter.svg',
    'MAPCO':'mapco.svg','RIDEX':'ridex.svg','PURFLUX':'purflux.svg',
    'FENNO':'fenno.svg','AHE':'ahe.svg','BIRTH':'birth.svg',
    'REMANTE':'remante.svg','SPIDAN':'spidan.svg','JAPANPARTS':'japanparts.svg',
    'WALKER':'walker.svg','OPTIMAL':'optimal.svg','DINEX':'dinex.svg',
    'NTK':'ntk.svg','HJS':'hjs.svg','BOSAL':'bosal.svg','FEBEST':'febest.svg',
    'AKRON-MAL\u00D2':'akron-malo.svg'
  };
  ...
  function renderProductPage(pageData) {
    ...
    if (brandFromData) {
      var logoFile = BRAND_LOGO_FILES[brandFromData] || '';
      if (logoFile) {
