(function() {
  ...
  // Cart row
  html += '<div class="an-cart-row" id="an-cart-row" style="display:flex!important;flex-direction:row-reverse!important;gap:8px!important;align-items:stretch!important;height:54px!important">';
  ...
  function moveCartRow() {
    ...
    if (twRow && cartRow) { twRow.style.cssText='display:none !important'; cartRow.style.cssText='display:flex!important;flex-direction:row-reverse!important;gap:8px!important;align-items:stretch!important;height:54px!important'; cartMoved=true; return true; }
    return false;
  }
  if (!moveCartRow()) {
  ...
  setTimeout(function() {
    ...
    if (cr && cr.style.display === 'none') {
      cr.style.cssText = 'display:flex!important;flex-direction:row-reverse!important;gap:8px!important;align-items:stretch!important;height:54px!important';
