(function() {
  ...
  // Cart row
  html += '<div class="an-cart-row" id="an-cart-row" style="display:flex!important;flex-direction:row!important;gap:12px!important;align-items:center!important">';
  ...
  function moveCartRow() {
    ...
    if (twRow && cartRow) { twRow.style.cssText='display:none !important'; cartRow.style.cssText='display:flex!important;flex-direction:row!important;gap:12px!important;align-items:center!important'; cartMoved=true; return true; }
    return false;
  }
  if (!moveCartRow()) {
  ...
  setTimeout(function() {
    ...
    if (cr && cr.style.display === 'none') {
      cr.style.cssText = 'display:flex!important;flex-direction:row!important;gap:12px!important;align-items:center!important';
