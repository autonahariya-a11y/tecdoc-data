...
(function () {
  ...
  var MODEL_HE = {
    ...
    'RANGE ROVER EVOQUE': '\u05E8\u05D9\u05D9\u05E0\u05D2\u05F3 \u05E8\u05D5\u05D1\u05E8 \u05D0\u05D9\u05D5\u05D5\u05D5\u05E7',
  ...
  function getProductPageData() {
    ...
    /* Image */
    var imgEl = document.querySelector('#item_show_carousel img') || document.querySelector('.item_image img') || document.querySelector('.main-image img');
  ...
  function renderProductPage(pageData) {
    ...
    /* Column 1: Image (clickable lightbox) */
  ...
  function renderVehicleAccordion(vehicles) {
    ...
    var html = '<div class="tw-vehicle-count-header"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="1" y="3" width="15" height="13"/><polygon points="16 8 20 8 23 11 23 16 16 16"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg><span>\u05DE\u05EA\u05D0\u05D9\u05DD \u05DC-<strong>' + mfrCount + '</strong> \u05D9\u05E6\u05E8\u05E0\u05D9 \u05E8\u05DB\u05D1</span></div>';
    ...
    for (var mk = 0; mk < mKeys.length; mk++) {
      ...
      html += '<div class="tw-acc-l1"><div class="tw-acc-l1-header" data-level="1"><span class="tw-acc-icon">+</span><span class="tw-acc-l1-name">' + esc(mfrHe) + '</span><span class="tw-acc-l1-count">' + modelCount + ' \u05D3\u05D2\u05DE\u05D9\u05DD</span></div><div class="tw-acc-l1-body">';
  ...
  function injectProductPage(pageData) {
    ...
    var hideSelectors = [
      '#item_main', '#item_info', '#item_show_facebook', '#item_group1'
    ];
  ...
  function bindImageLightbox(container) {
    var img = container.querySelector('.an-product__image img');
    if (!img) return;
