  ...
  function stylePurchaseArea() {
    ...
    if (!document.querySelector('#tw-purchase-css')) {
      ...
      s.textContent = [
        ...
        '.buy_now_button, .buy-now-button, [class*="buy_now"], [class*="buy-now"] { display: none !important; }',
        '.item_add_to_cart .item_quantity, .item_add_to_cart .quantity_up, .item_add_to_cart .quantity_down, .item_add_to_cart .item_quantity_input, .item_add_to_cart input[type="number"] { display:none !important; width:0 !important; height:0 !important; position:absolute !important; overflow:hidden !important; pointer-events:none !important; }',
        ...
        '#item_details .item_quantity:not(.tw-qty-selector), .item_main_bottom .item_quantity:not(.tw-qty-selector), .item_main_bottom > .item_quantity, #item_details .quantity_up, #item_details .quantity_down, .item_main_bottom .quantity_up, .item_main_bottom .quantity_down { display:none !important; width:0 !important; height:0 !important; position:absolute !important; overflow:hidden !important; }',
