...
(function () {
  ...
  /* Brand logo file mapping — loads from GitHub Pages /data/logos/ */
  var BRAND_LOGO_FILES = {
    'AISIN':'aisin.png',
    'ATE':'ate.png',
    'BERU':'beru.png',
    'BILSTEIN':'bilstein.png',
    'BLUE PRINT':'blue-print.png',
    'BOSCH':'bosch.png',
    'BREMBO':'brembo.png',
    'CASTROL':'castrol.png',
    ...
    'FAG':'fag.png',
    'FEBEST':'febest.png',
    'FEBI':'febi-bilstein.svg',
    'FEBI BILSTEIN':'febi-bilstein.svg',
    'FERODO':'ferodo.svg',
    'FILTRON':'filtron.png',
    'GATES':'gates.jpg',
    'HELLA':'hella.png',
    'HENGST':'hengst-filter.png',
    'HENGST FILTER':'hengst-filter.png',
    'HITACHI':'hitachi.png',
    'INA':'ina.png',
    'JAPANPARTS':'japanparts.png',
    'KNECHT':'knecht.svg',
    'KOLBENSCHMIDT':'kolbenschmidt.png',
    'KYB':'kyb.png',
    'LEMFORDER':'lemforder.png',
    'LEMF\u00D6RDER':'lemforder.png',
    'LIQUI MOLY':'liqui-moly.png',
    'LUK':'luk.png',
    'MAGNETI MARELLI':'magneti-marelli.png',
    'MAHLE':'mahle.svg',
    'MANN':'mann-filter.svg',
    'MANN-FILTER':'mann-filter.svg',
    'MEYLE':'meyle.png',
    'MOBIL':'mobil.png',
    'MONROE':'monroe.svg',
    'MOOG':'moog.png',
    'MOTUL':'motul.png',
    'NGK':'ngk.svg',
    'NIPPARTS':'nipparts.png',
    'NISSENS':'nissens.png',
    'NTN':'ntn.png',
    'OPTIMAL':'optimal.jpg',
    'OSRAM':'osram.png',
    'PHILIPS':'philips.png',
    'PIERBURG':'pierburg.png',
    'PURFLUX':'purflux.png',
    'RIDEX':'ridex.png',
    'SACHS':'sachs.svg',
    ...
    'VALEO':'valeo.svg',
    'VARTA':'varta.png',
    'VICTOR REINZ':'victor-reinz.png',
    'WAHLER':'wahler.png',
    'ZIMMERMANN':'zimmermann.png'
  };
  var LOGO_BASE_URL = BASE_URL + '/data/logos/';
  ...
  function renderProductPage(pageData) {
    ...
    purchaseHtml += '<div class="an-product__benefit an-product__benefit--warranty"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>\u05D0\u05D7\u05E8\u05D9\u05D5\u05EA 3 \u05D7\u05D5\u05D3\u05E9\u05D9\u05DD / 6,000 \u05E7"\u05DE</div>';
    if (brandFromData) {
    ...
    /* Product title — above the grid, full-width */
    ...
    /* Column 1: Image gallery with brand logo as small overlay + thumbnails */
    html += '<div class="an-product__image-col">';

    /* Main image with brand logo overlay */
    ...
    /* Brand logo — small overlay in corner of image area */
    if (brandFromData) {
      var logoFile = BRAND_LOGO_FILES[brandFromData] || BRAND_LOGO_FILES[brandFromData.toUpperCase()] || '';
      if (logoFile) {
        html += '<div class="an-product__brand-logo">';
        html += '<img src="' + esc(LOGO_BASE_URL + logoFile) + '" alt="' + esc(brandFromData) + '" onerror="this.parentNode.style.display=\'none\'">';
        html += '</div>';
      }
    }
    html += '</div>';
